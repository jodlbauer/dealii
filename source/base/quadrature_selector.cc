                                           ...
                                           const unsigned int order)
{
  if (s == "gauss")
    ...
    return QGaussLog<dim>(order);
  else if (s == "gauss_log_r")
    return QGaussLogR<dim>(order);
...
{
  return std::string(
    "gauss|gauss_lobatto|gauss_log|gauss_log_r|gauss_chebyshev|gauss_radau_chebyshev|gauss_lobatto_chebyshev|midpoint|milne|simpson|trapez|weddle");
}
